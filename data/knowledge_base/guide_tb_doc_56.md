---
docId: guide_tb_doc_56.md
version: 2.2
department: Maintenance Engineering
machine: Automated Guided Vehicle AGV-04
...
keywords: [automated, maintenance, guide_tb, pune]
---

# Pune Heavy Machinery Plant — Automated Guided Vehicle AGV-04 Troubleshooting Guide (Rev 2.2)

**Document ID:** GUIDE_TB-2026-1056  
**Facility Node:** Pune Heavy Machinery Plant (Pune, MH)  
**Equipment Tag:** Automated Guided Vehicle AGV-04  
...
This official enterprise technical document outlines standard operating directives, safety parameters, calibration guidelines, and maintenance protocols for Automated Guided Vehicle AGV-04 installed at Pune Heavy Machinery Plant.
